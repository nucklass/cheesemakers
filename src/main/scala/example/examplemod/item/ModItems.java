...
import scalastuff.MoldyCheeseSliceItem;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> MOLDY_CHEESE_SLICE_ITEM = 
	ITEMS.register(
		       "moldy_cheese_slice", 
		       () -> new MoldyCheeseSliceItem(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT))
		       );
